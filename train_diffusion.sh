...
DIFFUSION_SWEEPS=(
  "batch_size=128 dataloader.global_batch_size=128 lr=0.000012 adapter_lr=0.000012 light_transfer_lr=0.000010 backbone_lr=0.000002 train_diffusion_backbone=true train_diffusion_last_n_blocks=4 lambda_transfer=0.05 use_gt_source_light_prob=0.5 grad_clip_norm=0.3 q_clip=1.5 transfer_smooth_l1_beta=0.2"
  "batch_size=128 dataloader.global_batch_size=128 lr=0.000010 adapter_lr=0.000010 light_transfer_lr=0.000008 backbone_lr=0.000002 train_diffusion_backbone=true train_diffusion_last_n_blocks=8 lambda_transfer=0.05 use_gt_source_light_prob=0.5 grad_clip_norm=0.3 q_clip=1.5 transfer_smooth_l1_beta=0.2"
  "batch_size=128 dataloader.global_batch_size=128 lr=0.000008 adapter_lr=0.000010 light_transfer_lr=0.000008 backbone_lr=0.000001 train_diffusion_backbone=true train_diffusion_last_n_blocks=12 lambda_transfer=0.03 use_gt_source_light_prob=0.5 grad_clip_norm=0.25 q_clip=1.25 transfer_smooth_l1_beta=0.25"
  "batch_size=128 dataloader.global_batch_size=128 lr=0.000006 adapter_lr=0.000008 light_transfer_lr=0.000006 backbone_lr=0.000001 train_diffusion_backbone=true train_diffusion_last_n_blocks=16 lambda_transfer=0.02 use_gt_source_light_prob=0.75 grad_clip_norm=0.2 q_clip=1.25 transfer_smooth_l1_beta=0.25"
  "batch_size=96 dataloader.global_batch_size=96 lr=0.000010 adapter_lr=0.000012 light_transfer_lr=0.000008 backbone_lr=0.000003 train_diffusion_backbone=true train_diffusion_last_n_blocks=8 lambda_transfer=0.05 use_gt_source_light_prob=0.75 grad_clip_norm=0.3 q_clip=1.5 transfer_smooth_l1_beta=0.2"
  "batch_size=96 dataloader.global_batch_size=96 lr=0.000008 adapter_lr=0.000010 light_transfer_lr=0.000006 backbone_lr=0.000002 train_diffusion_backbone=true train_diffusion_last_n_blocks=12 lambda_transfer=0.1 use_gt_source_light_prob=0.75 grad_clip_norm=0.25 q_clip=1.5 transfer_smooth_l1_beta=0.2"
)
